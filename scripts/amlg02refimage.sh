...
BUILDDATE=$(date -I)
IMG_FILE="Volumio${VERSION}-${BUILDDATE}-amlg02ref.img"
...
then
	...
	git clone --depth 1 https://github.com/patrickkfkan/volumio-platform-aml.git platform-aml
#	cd ..
fi
...
cp platform-aml/g02ref/boot/uImage /mnt/volumio/rootfs/boot
cp platform-aml/g02ref/boot/aml_autoscript.cmd /mnt/volumio/rootfs/boot
echo "Copying modules"
cp -pdR platform-aml/g02ref/lib/modules /mnt/volumio/rootfs/lib/
echo "Copying firmware"
cp -pdR platform-aml/g02ref/lib/firmware /mnt/volumio/rootfs/lib/
echo "Copying etc files"
cp -pdR platform-aml/g02ref/etc/* /mnt/volumio/rootfs/etc
echo "Copying usr/bin files"
cp -pdR platform-aml/g02ref/usr/* /mnt/volumio/rootfs/usr
echo "Copying volumio fix"
cp -pdR platform-aml/g02ref/volumio/* /mnt/volumio/rootfs/volumio
cp -pdR platform-aml/g02ref/usr/local/bin/* /mnt/volumio/rootfs/usr/local/bin
sync

echo "Preparing to run chroot for more AML configuration"
cp scripts/amlg02refconfig.sh /mnt/volumio/rootfs
...
#cleanup
rm /mnt/volumio/rootfs/amlg02refconfig.sh
